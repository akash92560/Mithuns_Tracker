                               ...
                               // progressBar.setVisibility(View.GONE);
                                if (!task.isSuccessful()) {
                                    if(task.getException() instanceof FirebaseAuthUserCollisionException)
                                        Toast.makeText(SignupActivity.this,"EMail aleady registered",Toast.LENGTH_SHORT).show();
                                    else
                                    ...
                                    Toast.makeText(SignupActivity.this,"Verification Link sent",Toast.LENGTH_SHORT).show();
                                    finish();
