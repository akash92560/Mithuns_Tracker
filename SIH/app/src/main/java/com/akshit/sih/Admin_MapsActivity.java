...
public class Admin_MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__maps);
        initMap();
        ...
        myRef.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    String h=ds.child("location").getValue().toString();
                    String o=ds.getKey();
                    ...
                    mGoogleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener()
                    {
                        ...
                        public boolean onMarkerClick(Marker arg0) {
                            ...
                            if(arg0!=mCurrLocationMarker)
                            {
                                Intent i = new Intent(Admin_MapsActivity.this, Marker_MapsActivity.class);
        ...
        alertDialogBuilder.setMessage("GPS is disabled in your device. Would you like to enable it?")
                ...
                .setPositiveButton("Settings", new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int id)
                    {
                        ...
                        mapFrag.getMapAsync(Admin_MapsActivity.this);
                    }
                });
